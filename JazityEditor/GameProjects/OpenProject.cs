...
namespace JazityEditor.GameProjects
{
    ...
    class OpenProject
    {
        private static readonly string _applicationDataPath = $@"{Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData)}\JazityEditor\";
        private static readonly string _projectDataPath = null!;
        private static readonly ObservableCollection<ProjectData> _projects = new ObservableCollection<ProjectData>();

        public static ReadOnlyObservableCollection<ProjectData> Projects { get; } = null!;
        ...
        private static void ReadProjectData()
        {
            if (File.Exists(_projectDataPath))
            {
                ...
                foreach (var project in projects)
                {
                    ...
                    {
                        project.Icon = File.ReadAllBytes($@"{project.ProjectPath}\.Jazity\Icon.png");
                        project.Screenshot = File.ReadAllBytes($@"{project.ProjectPath}\.Jazity\Screenshot.png");
